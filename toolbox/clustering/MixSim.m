function [out]  = MixSim(k,v1,options)
...
if method == 0 || method == 1 || method == 1.5
    ...
    emax=ecc;
    Q = OmegaClust(Omega, method, v1, k, PiLow, Lbound, Ubound, ...
...
elseif method == 2
    ...
    Q = OmegaBarOmegaMax(v1, k, PiLow, Lbound, Ubound, ...
...
elseif method ==3
    ...
    emax=ecc;
    StdOmega=options.StdOmega;
    Q=OmegaBarOmegaStd(v1, k, PiLow, Lbound, Ubound, ...
